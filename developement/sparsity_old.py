...
from leastsquares_old import NormalEquationsInversion as normal_equations_inversion
from leastsquares_old import RegularizedInversion as regularized_inversion
...
def _IRLS_data(
    ...
    **kwargs_solver,
    ...
    xinv = normal_equations_inversion(Op, None, data, epsI=epsI, **kwargs_solver)
    r = data - Op * xinv
    if returnhistory:
        xinv_hist[0] = xinv
